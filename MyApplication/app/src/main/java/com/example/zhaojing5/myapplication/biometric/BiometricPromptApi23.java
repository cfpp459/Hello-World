...
/**
 * created by zhaojing 2019/12/25 上午11:39
 */
public class BiometricPromptApi23 implements IBiometricPromptImpl {
    public static final String TAG = BiometricPromptApi23.class.getSimpleName();
    ...
    public BiometricPromptApi23(Activity mActivity) {
        this.mActivity = mActivity;
        mFingerprintManager = getFingerprintManager(mActivity);
    }
    ...
    public void authenticate(@NonNull CancellationSignal cancel, @NonNull BiometricPromptManager.OnBiometricIdentifyCallback callback) {
        ...
        try{
            ...
            getFingerprintManager(mActivity).authenticate(cryptoObjectHelper.buildCryptoObject()
                    , mCancellationSignal
                    , 0
                    , mFmAuthCallback
                    , null);
